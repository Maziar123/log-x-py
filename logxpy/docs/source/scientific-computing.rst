...
* If you're using multiple worker machines, aggregate all log files into a single place, so you can more easily analyze them with e.g. `logxpy-tree <https://github.com/jonathanj/eliottree>`_.
* Replace ``dask.compute()`` with ``logxpy.dask.compute_with_trace()``.
* Replace ``dask.persist()`` with ``logxpy.dask.persist_with_trace()``.
...
.. code-block:: shell-session
   ...
   └── main_computation/1 ⇒ started 2019-01-01 17:27:13 ⧖ 0.047s
       ...
       │   ├── logxpy:remote_task/2/8/1 ⇒ started 2019-01-01 17:27:13 ⧖ 0.001s
       ...
       │   │   │       └── result: 7
       │   │   └── logxpy:remote_task/2/8/4 ⇒ succeeded 2019-01-01 17:27:13
       │   ├── logxpy:remote_task/2/9/1 ⇒ started 2019-01-01 17:27:13 ⧖ 0.001s
       ...
       │   │   │       └── result: 14
       │   │   └── logxpy:remote_task/2/9/4 ⇒ succeeded 2019-01-01 17:27:13
       │   ├── logxpy:remote_task/2/10/1 ⇒ started 2019-01-01 17:27:13 ⧖ 0.001s
       ...
       │   │   │       └── result: 21
       │   │   └── logxpy:remote_task/2/10/4 ⇒ succeeded 2019-01-01 17:27:13
       │   ├── logxpy:remote_task/2/11/1 ⇒ started 2019-01-01 17:27:13 ⧖ 0.001s
       ...
       │   │   │       └── result: 42
       │   │   └── logxpy:remote_task/2/11/5 ⇒ succeeded 2019-01-01 17:27:13
