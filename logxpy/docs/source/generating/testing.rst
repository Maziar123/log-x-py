...
Decorating a test function with ``logxpy.testing.capture_logging`` validation will ensure that:
...
.. code-block:: python
   ...
   from logxpy.testing import capture_logging
...
.. code-block:: python
    ...
    from logxpy import MemoryLogger
    from logxpy.testing import assertContainsFields, capture_logging
...
.. code-block:: python
    ...
    from logxpy.testing import assertHasMessage, capture_logging
...
More generally, ``logxpy.testing.LoggedAction`` and ``logxpy.testing.LoggedMessage`` are utility classes to aid such testing.
...
.. code-block:: python
    ...
    from logxpy.testing import LoggedMessage, capture_logging
...
.. code-block:: python
    ...
    from logxpy.testing import LoggedAction, LoggedMessage, capture_logging
    import searcher
...
.. code-block:: python
   ...
   from unittest import TestCase
   from logxpy.json import EliotJSONEncoder
   from logxpy.testing import capture_logging
...
.. code-block:: python
   ...
   from logxpy import MemoryLogger
   from logxpy.testing import swap_logger, check_for_errors
