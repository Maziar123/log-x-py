...
For Python 3.5 and 3.6 you will need to import either ``logxpy`` (or the backport package ``aiocontextvars``) before you create your first event loop.
...
Trying to improve this situation is covered in `issue #401 <https://github.com/itamarst/logxpy/issues/401>`_.
