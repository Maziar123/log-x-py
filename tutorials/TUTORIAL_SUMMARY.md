...
Use **`../examples-log-view/view_tree.py`** - Rich tree visualization (no dependencies required)
...
python ../examples-log-view/view_tree.py tutorial_01_basic.log

# ASCII mode (no Unicode)
python ../examples-log-view/view_tree.py tutorial_01_basic.log --ascii
```
...
```json
{"timestamp":1770283176.851,"task_uuid":"abc-123","message_type":"loggerx:info","message":"Application started","version":"1.0.0"}
{"timestamp":1770283176.851,"task_uuid":"def-456","message_type":"loggerx:success","message":"User logged in","user_id":"alice123"}
```
...
- **LogXPY docs:** `../logxpy/docs/`
- **LogXPY examples:** `../logxpy/examples/`
- **CLI viewer docs:** `../logxpy_cli_view/README.md`
...
Tree viewer:
../examples-log-view/view_tree.py  # Rich tree visualization
```
...
**File:** `logxpy/logxpy/__init__.py`
