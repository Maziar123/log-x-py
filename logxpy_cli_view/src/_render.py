...
from . import format
from ._color import color_factory, colored, _get_color_code
...
def _apply_fg_bg_colors(text: str, fg: str | None, bg: str | None) -> str:
    ...
    return text
from ._compat import get, get_message_type
from ._theme import Theme, get_theme
from ._util import Writable, logxpy_ns, eliot_ns, format_namespace, is_namespace
from .tree_format import ASCII_OPTIONS, Options, format_tree
