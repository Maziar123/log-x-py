...
from common.types import (
    TS, TID, LVL, MT, AT, ST, MSG, DUR,
)

# Viewer-specific color field names
FG = "fg"
BG = "bg"
...
# Field constants TS, TID, LVL, MT, AT, ST, MSG, DUR imported from common.types above
# FG, BG defined above (viewer-specific)
