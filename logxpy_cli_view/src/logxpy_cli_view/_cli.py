...
from logxpy_cli_view._export import ExportOptions, export_tasks
from logxpy_cli_view._stats import calculate_statistics, print_statistics
from logxpy_cli_view._tail import LiveDashboard, tail_logs, watch_and_aggregate
from logxpy_cli_view._theme import ThemeMode, apply_theme_overrides, get_theme
from logxpy_cli_view._util import Writable
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.command is None:
        # Create a render args namespace from defaults
        if args.files:
