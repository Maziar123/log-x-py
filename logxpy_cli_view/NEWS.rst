------------------------
logxpy-cli-view changelog
------------------------

.. towncrier release notes start

LogXPy CLI View 1.0.0 (2025-01-XX)
================================

Features
--------

* Initial release as logxpy-cli-view (forked from eliottree)
* Renamed from eliottree to logxpy-cli-view
* Added support for LogXPy's color fields (`logxpy:foreground`, `logxpy:background`)
* Added support for LogXPy's new log levels (SUCCESS, NOTE)
* Added emoji icons based on action type keywords
* Added live monitoring dashboard mode
* Added statistics aggregation
* Added pattern extraction (URLs, IPs, emails, UUIDs)
* Added export to logfmt format
* Added theme configuration via JSON config file

Changes from eliottree
---------------------

* Updated package name from `eliottree` to `logxpy-cli-view`
* Updated CLI command from `eliot-tree` to `logxpy-view`
* Added color block rendering from LogXPy color hints
* Added new filtering options for LogXPy-specific fields
* Enhanced emoji icon detection
* Updated documentation for LogXPy ecosystem

Compatibility
-------------

* Maintains compatibility with Eliot log format
* Can parse and display both Eliot and LogXPy logs
* Python 3.9+ support (improved from eliottree)
